        ...
        <div class="col-12 col-sm-4 p-4">
            <div class="row border border-secondary pb-5 bg-white">
                <div class="col-12 p-0">
                    ...
                    <p class="py-2 px-3 card">Alta, baja y modificación de un registro de clientes. Realizado en HTML, CSS, PHP, Bootstrap y Json.</p>
                </div>
                <div class="col-6">
                    <a href="#" class="btn-rojos">Ver online</a>
                </div>
                <div class="col-6 text-center">
                    <a href="#" class="link-rojos">Código fuente</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-4 p-4">
            <div class="row border border-secondary pb-5 bg-white">
                <div class="col-12 p-0">
                    ...
                    <h2 class="color-h2 py-3 px-3">SISTEMA DE GESTIÓN DE VENTAS</h2>
                    <p class="py-2 px-3 card">Alta, baja y modificación de un registro de clientes. Realizado en HTML, CSS, PHP, Bootstrap y Json.</p>
                </div>
                <div class="col-6">
                    <a href="#" class="btn-rojos">Ver online</a>
        ...
        <div class="col-12 col-sm-4 p-4">
            <div class="row border border-secondary pb-5 bg-white">
                <div class="col-12 p-0">
                    ...
                    <p class="py-2 px-3 card">Sistema de gestión de clientes, productos y ventas. Realizado en HTML, CSS, PHP, MVC, Bootstrap, Js, Ajax, jQuery y MySQL de base de datos.</p>
                </div>
